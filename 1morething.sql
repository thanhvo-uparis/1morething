...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 16 avr. 2021 à 13:10
...
CREATE TABLE `location` (
  `id` int(3) NOT NULL,
  `label` varchar(29) DEFAULT NULL,
  `parentId` varchar(3) DEFAULT NULL
...
INSERT INTO `location` (`id`, `label`, `parentId`) VALUES
(1, 'Nantes', ''),
